...
@section('content')
    ...
    <table class="min-w-full bg-white shadow-md rounded-lg overflow-hidden">
        ...
        <tr>
            ...
            <th class="py-3 px-6 text-left">Price ($)</th> <!-- New Column -->
        </tr>
        </thead>
        ...
        @forelse($deliveries as $delivery)
            <tr class="border-b border-gray-200 hover:bg-gray-100">
                ...
                <td class="py-3 px-6 text-left">{{ $delivery->price ?? '0.00' }}</td> <!-- New Value -->
            </tr>
        @empty
            <tr>
                <td colspan="7" class="text-center py-4 text-gray-500">No deliveries yet.</td>
            </tr>
        @endforelse
        </tbody>
    </table>
